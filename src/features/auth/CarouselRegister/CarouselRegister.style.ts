export const CarouselRegisterStyles = {
  base: "relative overflow-hidden rounded-lg h-full w-full",
  desktopOnly: "hidden md:block",
  showOnMobile: "block relative overflow-hidden rounded-lg h-full w-full",
  gradientOverlay:
  ...
  image: "h-screen object-cover w-full object-bottom",
