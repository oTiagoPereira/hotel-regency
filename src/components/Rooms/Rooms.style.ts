export const RoomsStyles = {
  ...
  leftControls: "flex flex-col md:flex-row gap-4 w-full md:w-auto flex-1",
  ...
  roomBadge: "w-10 h-10 rounded-lg bg-primary text-white flex items-center justify-center font-bold text-xs",
